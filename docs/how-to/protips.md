...
* Too many windows open, and you want to close them all? Open the CTRL menu and click on 'close all windows'!
...
* Want to take a short nap? Easily go to the CTRL menu and click on 'sleep mode' to enter a dialog where you can start timers and display idle texts.
* To turn off your password, change your password to 'ctrl'.
...
* You cannot delete the 'Admin' folder in CTRL. But. You can completely remove all apps, files, and directories to keep it non-intrusive to your freedom.
* You can switch the text app to 'Reading mode' to help your eyes while reading long documents.
* Want the current date in a text field? Drag and drop the CTRL Nav's time widget into the text field to get a time string.
