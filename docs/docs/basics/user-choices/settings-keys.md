...
| `timefrmt`        | Choose in what format time gets displayed in the _Lyra Nav_.                                      |
| `defSearchEngine` | Choose the default search engine for Lyra browser. (valid values are: NWP, Bing)                  |
