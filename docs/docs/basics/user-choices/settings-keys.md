...
| `timefrmt`        | Choose in what format time gets displayed in the _CTRL Nav_.                                      |
| `defSearchEngine` | Choose the default search engine for CTRL browser. (valid values are: NWP, Bing)                  |
